...
type ProfileStateType = MapStateToPropsType & MapDispatchToProps & OwnPropsType & typeof withRouter

const ProfileAJAX: React.FC<ProfileStateType> = (props) => {
    useEffect(() => {
...
export default compose<React.ComponentType<OwnPropsType>>(
    connect<MapStateToPropsType, MapDispatchToProps, OwnPropsType, AppStateType>(
        mapStateToProps, {getUsers, getStatus, updateStatus}
    ), withRouter
)(ProfileAJAX)
